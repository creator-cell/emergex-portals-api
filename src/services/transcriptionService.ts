...
export async function extractIncidentInfo(text: string): Promise<{
  incidentType: string;
  location: string;
  time: string;
  ...
  return {
    incidentType: "Fire حادث",
    location: "Dubai Industrial Area",
    time: "2026-02-10T14:30:00Z",
    numberOfInjuredPeople: 3,
    status: "Under Control",
    damageAssets: ["Warehouse A", "Two Trucks", "Electrical Panel"],
    finance: "Estimated loss: 250000 USD",
  };
}
