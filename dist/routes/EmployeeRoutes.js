...
router.get("/not-in-team", authMiddleware_1.authenticate, (0, roleMiddleware_1.authorizeRoles)(global_enum_1.GlobalAdminRoles.SuperAdmin), employeeValidators_1.validateCreateEmployee, EmployeeControllers_1.getUnassignedEmployees);
router.route('/not-in-project/:id').get(authMiddleware_1.authenticate, (0, roleMiddleware_1.authorizeRoles)(global_enum_1.GlobalAdminRoles.SuperAdmin, global_enum_1.GlobalAdminRoles.ClientAdmin), EmployeeControllers_1.getEmployeesNotInProject);
