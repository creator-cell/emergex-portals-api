...
const imageNormalizer_1 = require("../middlewares/imageNormalizer");
const router = (0, express_1.Router)();
router
    .route("/")
    .post(authMiddleware_1.authenticate, (0, roleMiddleware_1.authorizeRoles)(global_enum_1.GlobalAdminRoles.SuperAdmin, global_enum_1.GlobalAdminRoles.ClientAdmin), incidentValidators_1.incidentValidationRules, checkValidationsMiddleware_1.checkValidationResult, imageNormalizer_1.normalizeImageData, IncidentControllers_1.createIncident);
