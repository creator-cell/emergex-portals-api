...
router.put('/add-member/:id', authMiddleware_1.authenticate, (0, roleMiddleware_1.authorizeRoles)(global_enum_1.GlobalAdminRoles.SuperAdmin, global_enum_1.GlobalAdminRoles.ClientAdmin), teamValidators_1.addRemoveTeamMemberValidation, checkValidationsMiddleware_1.checkValidationResult, TeamControllers_1.addNewMemberToTeam);
router.put('/remove-member/:id', authMiddleware_1.authenticate, (0, roleMiddleware_1.authorizeRoles)(global_enum_1.GlobalAdminRoles.SuperAdmin, global_enum_1.GlobalAdminRoles.ClientAdmin), teamValidators_1.addRemoveTeamMemberValidation, checkValidationsMiddleware_1.checkValidationResult, TeamControllers_1.removeMemberFromTeam);
